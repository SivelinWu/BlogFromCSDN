...
![](/cdn/158495878/0aa820a4786a42f1a7b6dec6b83491c0.png)
插件安装完毕后记得在扩展管理中开启。
![](/cdn/158495878/9ff094f5b45a45af80316953684de2cd.png)
然后点击浏览器中插件图标就可以看到弹出一个Midscene.js的侧边栏
![](/cdn/158495878/b6f76698958e4b7ab7961c623ab93670.png)
但此时还不能直接使用，还需要对使用的AI大模型进行配置，点击左上角的设置图标
![](/cdn/158495878/d47ab45faf29479f8aa453c134aa2856.png)
...
类似的方法还有 `aiBoolean()`, `aiNumber()`, `aiString()`，用于直接提取布尔值、数字和字符串。
  ...
  * Tap: 在某个元素上点击，这就是即时操作（Instant Action），对应于 `aiTap` 方法。
    ...
    点击登录按钮
下面以打开百度进行搜索为例：
![](/cdn/158495878/6c6b29cd220f4309b90f6e288e0e0241.png)
![](/cdn/158495878/34100b0c92e14d21a1fe4d52bbdf82da.png)
![](/cdn/158495878/c94e21fd8fbe4105824c1f27b9d7ee2f.png)
...
如下是执行窗口：
![](/cdn/158495878/5037749a1f7a4e0ab0376ebb7037f4de.png)
如下是报告视图：
![](/cdn/158495878/57bcbb0efcb145abb370340b56c95c93.png)
### 四、更多进阶用法
